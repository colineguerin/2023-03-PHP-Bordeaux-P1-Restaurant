            ...
            <!-- I will probably delete the wines, but I keep it in comment just in case
                <div id="ms-menu-wines">
                    <h3>Blancs</h3>
                        ...
                        <p class="ms-dish-label">Château Flots bleus, Cabernet Sauvignon</p>
                        <p class="ms-dish-price">22 €</p>
                        <p class="ms-dish-label">Château la mer</p>
                        <p class="ms-dish-price">28 €</p>
                    <h3>Rouges</h3>
                        <p class="ms-dish-label">Château de la Grue, Syrah</p>
                        <p class="ms-dish-price">19 €</p>
                        <p class="ms-dish-label">Château Lacaze, Petit Verdot</p>
                        <p class="ms-dish-price">32 €</p>
                    <h3>Rosés</h3>
